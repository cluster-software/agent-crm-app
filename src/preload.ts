...
const bridge: AppBridge = {
  ...
  getPersonRelated: (personRecordId, object) => invoke("people:related", personRecordId, object),
  getCompanyTeam: (companyRecordId) => invoke("companies:team", companyRecordId),
  getCommunicationThreadMessages: (threadRecordId) => invoke("communication-threads:messages", threadRecordId),
  getRecordLabels: (objectSlug, recordIds) => invoke("records:labels", objectSlug, recordIds),
  getPersonCompany: (personRecordId) => invoke("people:company", personRecordId),
